...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tvTitle.setText(listItem.getAccount_id ());
        holder.tvDescription.setText(listItem.getDisplay_name ());
        Picasso.with(context).load(listItem.getDisplay_image ()).into(holder.imageView);
